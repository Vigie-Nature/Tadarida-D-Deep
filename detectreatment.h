...
// modifie le 2/8/2022 pour version tadariDdeep
...
public:
    ...
    void                                                                 SetGlobalParameters(int,int,int,int,int,int,int,bool,int,int,int,int,int,int,int,int,int,int,bool,double);
